...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.imthinker.ti.imagemanipulator.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','NetImthinkerTiImagemanipulatorModuleAssets.m')
